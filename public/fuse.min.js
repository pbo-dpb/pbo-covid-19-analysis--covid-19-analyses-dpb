...
((e = this),
    (t = function () {
        ...
        var P = (function () {
                function e(n) {
                    ...
                    if (
                        ...
                        if (b > 32) {
                            for (var S = 0, _ = b % 32, w = b - _; S < w;)
                                (x(this.pattern.substr(S, 32), S), (S += 32));
                            if (_) {
                                var O = b - 32;
        ...
        var z = (function (e) {
            ...
            V = (function (e) {
                ...
                function i(e) {
                    ...
                    return (
                        t(this, i),
                        ((r = n.call(this, e))._bitapSearch = new P(e, {
                            location: a,
                            threshold: u,
                            distance: f,
                            includeMatches: d,
        ...
        var X = new Set([V.type, U.type]),
            Y = (function () {
                function e(n) {
                    ...
                    (t(this, e),
                        ...
                        (this.query = Q(this.pattern, this.options)));
                }
                return (
                    r(
                        e,
            ...
            Z = [];
        function ee(e, t) {
            for (var n = 0, r = Z.length; n < r; n += 1) {
                var i = Z[n];
                                                ...
                                                if (!n.children) {
                                                    var o = n.keyId,
                                                        ...
                                                        a = t._findMatches({
                                                            ...
                                                            value: t._myIndex.getValueForItemAtKeyId(
                                                                r,
                                                                o,
                                                            ),
                                                            searcher: c,
