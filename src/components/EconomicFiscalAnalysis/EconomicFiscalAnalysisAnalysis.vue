<template>
    <div>
        ...
        <markdown-content
            :content="efa.description[$root.language]"></markdown-content>

        <aside class="mx-2 my-8 rounded-lg bg-blue-100 p-2">
            <div
                class="col-span-2 mb-2 border-b border-blue-800 pb-2 text-center text-lg leading-none md:col-span-6">
                <component
                    :is="'div'"
                    class="font-bold text-blue-800"
                    >{{ $root.strings.efas.read_report_cta }}</component
                >
            </div>
            <div class="md:px-2">
        ...
        <li
            class="grid items-center gap-2 border-t border-gray-200 py-2 md:grid-cols-8 md:py-1"
            :class="['grid-cols-' + countOfYears]">
            <div
                class="text-center leading-tight md:text-left"
                :class="[
                ...
                <component
                    :is="'span'"
                    class="font-medium"
                    >{{ $root.strings.efas.other_measures.title }}</component
                >
                <div class="font-thin">
            ...
            <div
                v-for="year in efa.otherMeasures.cost.localizedCost(
                    $root.language,
                )"
