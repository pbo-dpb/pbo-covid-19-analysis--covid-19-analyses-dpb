    ...
    <div>
        ...
        <div class="relative">
            <select
                ...
                @change="listen"
                class="block w-full appearance-none rounded-sm border border-gray-200 bg-gray-200 px-2 py-2 pr-8 leading-tight text-gray-700 focus:border-gray-500 focus:bg-white focus:outline-hidden">
                <option :value="null">&mdash;</option>
                <option
                    v-for="option in options"
                    :value="option"
                    :key="option.title_en">
                    {{ option["title_" + $root.language] }}
                </option>
            </select>
            <div
