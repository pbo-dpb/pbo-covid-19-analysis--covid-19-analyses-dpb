<template>
    <div>
        <markdown-content
            :content="$root.strings.costingerp.descriptor"></markdown-content>

        <br />
        <measures-list
            :measures="msses"
            :prefer-net-cost="true"></measures-list>

        <div class="my-4 border-t border-gray-100 pt-4 text-sm text-gray-800">
