        ...
        <table class="w-full table-fixed">
            <thead>
                <tr>
                    ...
                    <th
                        v-for="localizedCostedYear in $root.strings.costingerp
                            .costed_years"
            ...
            <tbody>
                <tr
                    ...
                    :prefer-net-cost="preferNetCost"></tr>
            </tbody>
        </table>
    </figure>
</template>
<script>
    ...
    export default {
        ...
        computed: {
            ...
            costings() {
                return collect(this.measure.costings).when(
                    this.preferNetCost,
                    (coll) => {
                        return coll.reject(
                            (costing) => costing.hideFromMeasuresTable,
                        );
                    },
                ).items;
            },
